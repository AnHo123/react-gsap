...
export default function CardScroll() {
  ...
  return (
    ...
    >
      <motion.h1
        className="cards-wrapper-title sticky top-0 px-8 py-6 w-full text-4xl md:text-6xl flex flex-col items-center font-extrabold text-black text-center z-[1000] text-center"
